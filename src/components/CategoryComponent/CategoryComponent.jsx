...
import { getProductByCategory } from "../../redux/products/productOperations";
...
const CategoryComponent = ({ category }) => {
  ...
  useEffect(() => {
    dispatch(getProductByCategory({ category, page: currentPage, limit: itemsPerPage }));
  ...
  const totalPages = Math.ceil(productList.total / itemsPerPage);
            ...
            <CardWrapper>
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography variant="body2">Ціна: {product.price}</Typography>
                </CardContent>
              </Link>
            </CardWrapper>
          </div>
